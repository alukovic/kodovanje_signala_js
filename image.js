...
window.addEventListener('load', function(){
    ...
    document.querySelector('input[type="file"]').addEventListener('change', function(){
        ...
        if(this.files && this.files[0]){
            ...
            console.log(memorijskoZauzeceVrednost, ' bytes'); 
    ...
    let iA = 0; 
    let tekst = 'Loading...';
    txtUcitavanje.innerHTML += 'Loading...'; 
...
const obradaUlazneSlike = () => {
    ...
    */
    ...
    console.log('All input image data: ', podaciUlazneSlike);
...
const podaciKompresijeA = () => {
    ...
    rezolucijaA.value = `${canvasSlike.width} x ${canvasSlike.height} pixels`; 
